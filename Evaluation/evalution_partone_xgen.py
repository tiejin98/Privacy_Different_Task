...
with open("Direct Output/evaluate_direct.json", 'r') as f:
    data = json.load(f)
...
model.load_adapter("LoRA-FP16-finetune-xgen/checkpoint-60",adapter_name="lora")
...
for task in tasks:
    ...
    for i in tqdm(range(1, len(data) + 1)):
        image_path = "Direct Output/Direct/{}.png".format(i)
        sample_dict = {}
        ...
        res[i] = sample_dict
        np.save("part1_xgen3_finetune_{}.npy".format(task), res)
